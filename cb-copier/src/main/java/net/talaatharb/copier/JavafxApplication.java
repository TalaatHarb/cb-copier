...
import net.talaatharb.copier.ui.events.StageReadyEvent;
...
public class JavafxApplication extends Application {
	...
	private static final String TITLE = "Couchbase Copier";
	...
	public void init() throws Exception {
		...
		context = new SpringApplicationBuilder().sources(CBCopierApplication.class).initializers(initializer)
